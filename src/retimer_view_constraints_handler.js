/* TODO:
    1) snap the constraints back to a vertical position when they are dragged
    2) Make sure that global time/audio time is used in all appropriate places instead of visual time
        2a) figure out where it is appropriate to use visual time (i.e. if there is no audio recording)
...
// TODO: use from retimer controller...
